...
public class RestaurantControllerTests {
    ...
    public void detailWithExisted() throws Exception{
        ...
        Restaurant restaurant = Restaurant.builder().id(1004L).categoryId(1L).name("JOKER HOUSE").address("Seoul").build();
    ...
    public void createwithValidData() throws Exception {
        ...
        given(restaurantService.addRestaurant(any())).will(invocation->{
            ...
            return Restaurant.builder().id(1234L).categoryId(1L).name(restaurant.getName()).address(restaurant.getAddress()).build();
        });
